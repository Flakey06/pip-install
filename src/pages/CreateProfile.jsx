    ...
    <div style={{ minHeight: "100vh", background: "white", display: "flex", justifyContent: "center", padding: "0 24px" }}>
      <div style={{ width: "100%", maxWidth: "420px", paddingTop: "60px", paddingBottom: "60px" }}>
        ...
        <div style={{ marginBottom: "16px" }}>
          ...
          <input value={username} onChange={e => setUsername(e.target.value)} placeholder="e.g. jamie123" style={inputStyle} />
        </div>

        <div style={{ marginBottom: "16px" }}>
          <label style={labelStyle}>Major *</label>
          <input value={major} onChange={e => setMajor(e.target.value)} placeholder="e.g. Computer Science" style={inputStyle} />
        </div>
        ...
        <div style={{ marginBottom: "16px" }}>
          ...
          <input value={telegram} onChange={e => setTelegram(e.target.value)} placeholder="e.g. @pip-install" style={inputStyle} />
        </div>
